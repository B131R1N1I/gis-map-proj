...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterType<MapQuickView>("Esri.gis_project", 1, 0, "MapView");

    // Register the Gis_project (QQuickItem) for QML
    qmlRegisterType<Gis_project>("Esri.gis_project", 1, 0, "Gis_project");
